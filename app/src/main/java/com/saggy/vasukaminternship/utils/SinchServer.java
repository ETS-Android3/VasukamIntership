...
public class SinchServer extends Service {
    ...
    private static final String APP_SECRET = "your app secret here";
    private static final String ENVIRONMENT = "clientapi.sinch.com";

    public static final String CALL_ID = "CALL_ID";
    static final String TAG = SinchServer.class.getSimpleName();
    ...
    private void start(final String userName) {
    ...
    private class SinchCallClientListener implements CallClientListener {
        ...
        public void onIncomingCall(CallClient callClient, Call call) {
            ...
            Intent intent = new Intent(SinchServer.this, Video_Call.class);//Incomingcallactivity
            intent.putExtra(CALL_ID, call.getCallId());
            intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            SinchServer.this.startActivity(intent);
        }
    }
}
